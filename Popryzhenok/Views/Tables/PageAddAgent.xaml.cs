    ...
    public partial class PageAddAgent : Page
    {
        ...
        private void buttonLogo_Click(object sender, RoutedEventArgs e)
        {
            OpenFileDialog openFileDialog = new OpenFileDialog()
            {
                ...
                InitialDirectory = projectDirectory + @"\Popryzhenok_\agents\"
            };
            ...
            if (result == true)
            {
                ...
                try
                {
                    File.Copy(filename, $"{projectDirectory}/Popryzhenok_{tbLogo.Text}");
        ...
        private void Page_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                photo.Source = new BitmapImage(new Uri($"{projectDirectory}/Popryzhenok_/{NewAgent.Logo}"));
            }
            catch (Exception)
            {
                return;
